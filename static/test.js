var SimplybookWidgetRW = function (options) {
  this.options = {
    //Simon Hack options
    element:"",
    // common options
...
SimplybookWidgetRW.prototype.init = function () {
...
SimplybookWidgetRW.prototype.onReceiveMessage = function (message) {
...
SimplybookWidgetRW.prototype.setSettings = function () {
...
SimplybookWidgetRW.prototype.navigate = function (to) {
  var win = this.frame.contentWindow || this.frame
...
SimplybookWidgetRW.prototype.scrollToContent = function (contentPos) {
...
SimplybookWidgetRW.prototype.changeModalPosition = function (listenerId) {
...
SimplybookWidgetRW.prototype.saveModalPosition = function (listenerId) {
  var scrollTop = window.pageYOffset || document.documentElement.scrollTop

  this.modalsPositions[listenerId] = scrollTop
}

SimplybookWidgetRW.prototype.updatePositionAfterModal = function (listenerId) {
  if (this.modalsPositions[listenerId]) {
    window.scrollTo(0, this.modalsPositions[listenerId])
  }
}

SimplybookWidgetRW.prototype.getUrl = function () {
...
SimplybookWidgetRW.prototype.subscribeMessages = function () {
  var instance = this
...
SimplybookWidgetRW.prototype.updateWidgetSize = function (data) {
  if (
    this.options.widget_type !== 'iframe' &&
    this.options.widget_type !== 'reviews'
  ) {
    return
  }
...
SimplybookWidgetRW.prototype.displayIframe = function () {
   var el = document.getElementById(this.options.element)  

 // document.write(
    el.innerHTML= 
        '<iframe scrolling="no" class="sb-widget-iframe" width="100%" border="0" frameborder="0" src="' +
        this.getUrl() +
        '" name="' +
        this.name +
        '" id="' +
...
SimplybookWidgetRW.prototype.addButton = function () {
...
SimplybookWidgetRW.prototype.addContactButton = function () {
  this.addButtonWidgetStyles()
...
SimplybookWidgetRW.prototype.getButtonNode = function () {
...
SimplybookWidgetRW.prototype.updateButtonStyles = function (options) {
  if (!this.btn) {
    return
  }
  if (options) {
  ...
  this.btn.className =
    'simplybook-widget-button ' + this.options.button_position
  this.btn.style.backgroundColor = this.options.button_background_color
  this.btn.style.color = this.options.button_text_color
  if (
    this.options.button_position === 'top' ||
    this.options.button_position === 'bottom'
  ) {
...
SimplybookWidgetRW.prototype.resetWidget = function (options) {
...
SimplybookWidgetRW.prototype.showPopupFrame = function (navigateTo) {
...
SimplybookWidgetRW.prototype.closePopup = function () {
  this.hideOverlay()
  this.container.className = 'simplybook-widget-container'
}

SimplybookWidgetRW.prototype.showOverlay = function () {
  if (!this.overlay) {
...
SimplybookWidgetRW.prototype.hideOverlay = function () {
  if (this.overlay) {
    this.overlay.className = 'simplybook-widget-overlay'
...
SimplybookWidgetRW.prototype.addButtonWidgetStyles = function () {
...
SimplybookWidgetRW.prototype.getIframeNode = function () {
  if (!this.frame) {
